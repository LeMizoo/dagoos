function init_drivers() {
    ...
    main.innerHTML = '<div class="topbar"><h1><i class="fas fa-motorcycle"></i> Chauffeurs</h1></div><div class="card"><table><thead><tr><th>Code</th><th>Nom</th><th>Statut</th></tr></thead><tbody id="driversTable"></tbody></table></div>';
    loadDrivers();
}
