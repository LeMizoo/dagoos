function init_settings() {
    ...
    main.innerHTML = 
        ...
        '<button onclick="saveAllSettings()" style="width:100%;padding:16px;background:#27AE60;color:white;border:none;border-radius:12px;font-size:16px;font-weight:700;cursor:pointer;margin-top:24px;">💾 Enregistrer</button>' +
