function init_settings() {
    ...
    main.innerHTML = 
        ...
        '<button onclick="saveAllSettings()" style="width:100%;padding:16px;background:#27AE60;color:white;border:none;border-radius:12px;font-size:16px;font-weight:700;cursor:pointer;margin-top:24px;"><i class="fas fa-save"></i> Enregistrer</button>' +
...
async function loadProfilSettings() {
    ...
    if (org.plan === 'Premium' || org.plan === 'Standard') {
        ...
        html += '<div style="background:#D1FAE5;border-radius:12px;padding:16px;margin-top:16px;text-align:center;">' +
            ...
            '<a href="' + vitrineUrl + '" target="_blank" style="color:#27AE60;font-weight:600;">' + vitrineUrl + '</a></div>';
    } else {
