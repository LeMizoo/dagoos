    ...
    document.getElementById('mainContent').innerHTML = 
        ...
        '<div style="padding:24px;">' +
            '<div class="stats-grid">' +
                '<div class="stat-card"><div class="stat-number" id="driverCourses">-</div><div class="stat-label">Courses aujourd\'hui</div></div>' +
                '<div class="stat-card"><div class="stat-number" id="driverRevenus">-</div><div class="stat-label">Revenus</div></div>' +
            '</div>' +
