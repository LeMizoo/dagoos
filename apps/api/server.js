...
const allowedOrigins = (process.env.CORS_ORIGINS || "http://localhost:5001,http://localhost:5000,http://localhost:8080,http://localhost:8081,http://localhost:8082,http://localhost:8090,http://127.0.0.1:8080,http://127.0.0.1:8081,http://127.0.0.1:8082,http://127.0.0.1:8090,https://dago-mobility.vercel.app,https://dago-driver.pages.dev,https://dago-coop-driver.pages.dev,https://dago-mobile.pages.dev,http://localhost:3000")
  .split(",")
...
// Forcer le charset UTF-8 sur toutes les réponses JSON
...
app.use('/api/drivers', require('./modules/drivers/stats.routes'));
