...
const allowedOrigins = (process.env.CORS_ORIGINS || "http://localhost:5001,http://localhost:5000,http://localhost:8080,http://127.0.0.1:8080,https://dago-mobility.vercel.app,https://dago-driver.pages.dev,https://dago-coop-driver.pages.dev,https://dago-mobile.pages.dev,http://localhost:3000")
  .split(",")
