...
const allowedOrigins = (process.env.CORS_ORIGINS || "http://localhost:5001,https://dago-mobility.vercel.app,https://dago-driver.pages.dev,https://dago-coop-driver.pages.dev,https://dago-mobile.pages.dev,http://localhost:3000")
  .split(",")
