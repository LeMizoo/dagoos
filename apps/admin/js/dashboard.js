...
async function loadLandingEditor() {
    try {
        ...
        var h = '<div class="card" style="padding:24px;"><h3>📄 Contenu de la landing page</h3><p style="color:var(--text2);">Modifiez les textes affiches sur dago-mobility.pages.dev</p>';
