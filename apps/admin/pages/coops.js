function init_coops() {
    ...
    main.innerHTML = '<div class="topbar"><h1>🏢 Coopératives</h1><button class="btn btn-primary btn-sm" onclick="addOrg(\'COOPERATIVE\')"><i class="fas fa-plus"></i> Ajouter</button></div><div class="card"><table><thead><tr><th>Nom</th><th>Code</th><th>Email</th><th>Plan</th><th>Statut</th><th>Actions</th></tr></thead><tbody id="coopsTable"></tbody></table></div>';
    loadCoops();
}
