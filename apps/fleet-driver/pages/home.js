    ...
    main.innerHTML =
        ...
        '<div style="background:#1E293B;padding:10px 14px;display:flex;align-items:center;justify-content:space-between;position:sticky;top:0;z-index:100;border-bottom:1px solid #DAA520;">' +
            ...
            '<div style="display:flex;gap:4px;">' +
                ...
                '<button onclick="loadPage(\'profil\')" style="background:rgba(255,255,255,0.1);border:none;width:32px;height:32px;border-radius:50%;color:#DAA520;cursor:pointer;font-size:14px;" aria-label="Profil">' +
                    'Profil' +
                '</button>' +

                '<button onclick="logout()" style="background:rgba(239,68,68,0.15);border:none;width:32px;height:32px;border-radius:50%;color:#F87171;cursor:pointer;font-size:12px;" aria-label="Déconnexion">' +
                    'Quitter' +
                '</button>' +
