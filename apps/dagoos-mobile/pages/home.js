    ...
    <div style="padding:16px;">
      ...
      <div onclick="loadPage('course')" style="background:#252540;border-radius:14px;padding:16px;margin-bottom:10px;cursor:pointer;display:flex;align-items:center;gap:14px;border:1px solid rgba(16,185,129,0.2);">
        ...
        <div style="flex:1;">
          ...
          <div style="display:flex;gap:8px;margin-top:6px;">
            <span style="font-size:9px;background:rgba(16,185,129,0.15);color:#F59E0B;padding:3px 8px;border-radius:20px;">Géolocalisation</span>
            <span style="font-size:9px;background:rgba(16,185,129,0.15);color:#F59E0B;padding:3px 8px;border-radius:20px;">Rapide</span>
          </div>
        </div>
      ...
      <div onclick="loadPage('reservations')" style="background:#252540;border-radius:14px;padding:16px;margin-bottom:10px;cursor:pointer;display:flex;align-items:center;gap:14px;border:1px solid rgba(16,185,129,0.2);">
        ...
        <div style="flex:1;">
          ...
          <div style="display:flex;gap:8px;margin-top:6px;">
            <span style="font-size:9px;background:rgba(16,185,129,0.15);color:#F59E0B;padding:3px 8px;border-radius:20px;">Réservation</span>
            <span style="font-size:9px;background:rgba(16,185,129,0.15);color:#F59E0B;padding:3px 8px;border-radius:20px;">Confort</span>
          </div>
        </div>
        <span style="color:#F59E0B;font-size:20px;">→</span>
      </div>
      ...
      <div onclick="loadPage('location')" style="background:#252540;border-radius:14px;padding:16px;margin-bottom:10px;cursor:pointer;display:flex;align-items:center;gap:14px;border:1px solid rgba(16,185,129,0.2);">
        ...
        <div style="flex:1;">
          ...
          <div style="display:flex;gap:8px;margin-top:6px;">
            <span style="font-size:9px;background:rgba(16,185,129,0.15);color:#F59E0B;padding:3px 8px;border-radius:20px;">Avec chauffeur</span>
            <span style="font-size:9px;background:rgba(16,185,129,0.15);color:#F59E0B;padding:3px 8px;border-radius:20px;">Flexible</span>
          </div>
        </div>
        <span style="color:#F59E0B;font-size:20px;">→</span>
      </div>
      ...
      <div onclick="loadPage('location')" style="background:#252540;border-radius:14px;padding:16px;margin-bottom:10px;cursor:pointer;display:flex;align-items:center;gap:14px;border:1px solid rgba(16,185,129,0.2);">
        ...
        <div style="flex:1;">
          ...
          <div style="display:flex;gap:8px;margin-top:6px;">
            <span style="font-size:9px;background:rgba(16,185,129,0.15);color:#F59E0B;padding:3px 8px;border-radius:20px;">Longue distance</span>
            <span style="font-size:9px;background:rgba(16,185,129,0.15);color:#F59E0B;padding:3px 8px;border-radius:20px;">Multi-jours</span>
          </div>
        </div>
        <span style="color:#F59E0B;font-size:20px;">→</span>
      </div>
