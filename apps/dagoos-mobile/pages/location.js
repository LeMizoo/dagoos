function init_location() {
  ...
  app.innerHTML = `
    <div style="background:#064E3B;padding:16px;display:flex;align-items:center;gap:12px;position:sticky;top:0;z-index:50;">
      ...
      <div style="font-size:16px;font-weight:800;color:#10B981;">Location de véhicules</div>
    </div>
    <div style="padding:16px;">
      <div style="background:#064E3B;border-radius:14px;padding:16px;margin-bottom:10px;">
      ...
      <div style="background:#064E3B;border-radius:14px;padding:16px;">
