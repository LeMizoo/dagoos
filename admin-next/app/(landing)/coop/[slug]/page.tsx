      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-white">
        <div className="max-w-md mx-auto text-center p-8">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 mt-6">
            ...
            <Link href="/register" className="inline-block bg-primary text-white px-6 py-3 rounded-xl font-semibold hover:bg-emerald-800 transition text-sm">
              Voir les plans →
            </Link>
          </div>
    ...
    <div className="min-h-screen bg-white">
      ...
      <footer className="bg-gray-900 text-gray-400 py-8 text-center text-sm">
        <div className="flex items-center justify-center gap-2 mb-2">
          <Building2 size={16} /> <span className="font-bold text-white">{org.name}</span>
        </div>
