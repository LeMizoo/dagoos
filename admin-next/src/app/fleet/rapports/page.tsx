      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {[
          ...
          <div key={r.title} className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition flex items-start gap-4">
            <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center flex-shrink-0"><r.icon size={24} className="text-blue-600" /></div>
            ...
            <button className="text-blue-600 hover:bg-blue-50 p-2 rounded-lg transition"><Download size={18} /></button>
          </div>
        ))}
      </div>
    </div>
