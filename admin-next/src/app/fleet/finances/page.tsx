  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-white rounded-xl p-5 shadow-sm border"><div className="flex items-center gap-3 mb-2"><div className="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center"><Wallet size={20} className="text-blue-600" /></div><span className="text-sm text-gray-500">Solde</span></div><div className="text-2xl font-bold text-blue-600">{loading ? '-' : `${(revenus - depenses).toLocaleString()} Ar`}</div></div>
      </div>
