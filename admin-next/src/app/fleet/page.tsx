...
export default function FleetHome() {
  return (
    <div>
      <h1 className="text-2xl font-bold text-gray-800 mb-6">📊 Tableau de bord Flotte</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <StatCard icon={DollarSign} label="Revenus (Ar)" value={0} color="yellow" />
        <StatCard icon={MessageSquare} label="Messages" value={0} color="red" />
      </div>
    </div>
  );
}
