        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border">
          ...
          <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-750 rounded-lg border">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between"><span className="text-gray-500">🏢 Organisation</span><span className="text-blue-600 font-bold">{100 - tarifs.commissionChauffeur}%</span></div>
            </div>
          </div>
        </div>
      </div>
