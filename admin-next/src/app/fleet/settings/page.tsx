...
const DEFAULT_TARIFS: Record<string, { prixBase: number; prixKm: number; locationJournalier: number }> = {
  moto: { prixBase: 2000, prixKm: 500, locationJournalier: 15000 },
  voiture: { prixBase: 4000, prixKm: 800, locationJournalier: 35000 },
  bus: { prixBase: 6000, prixKm: 1200, locationJournalier: 60000 },
  minivan: { prixBase: 5000, prixKm: 1000, locationJournalier: 50000 },
  tricycle: { prixBase: 1500, prixKm: 400, locationJournalier: 12000 },
};
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center"><DollarSign size={20} className="text-blue-600" /></div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-sm border">
          ...
          <div className="bg-gray-50 dark:bg-gray-750 rounded-lg p-4 border">
            ...
            <div className="space-y-1 text-xs">
              ...
              <div className="flex justify-between"><span>🏢 Flotte</span><span className="text-blue-600 font-bold">{100 - commission}%</span></div>
            </div>
          </div>
        </div>
      </div>
      <div className="mt-6"><button onClick={handleSave} className="bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center gap-2 hover:bg-blue-700 text-sm"><Save size={16} /> {saved ? '✓ Sauvegardé !' : 'Sauvegarder'}</button></div>
    </div>
  );
}
