    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 to-cyan-700">
      <div className="bg-white rounded-2xl p-10 w-full max-w-md shadow-2xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-800">Espace Flotte</h1>
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input type="email" value={email} onChange={e => setEmail(e.target.value)}
              ...
              placeholder="fleet@exemple.mg" required />
          </div>
          <div className="mb-6">
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          Vous n&apos;avez pas de compte ? <a href="/register" className="text-blue-600 hover:underline">Inscrivez-vous</a>
        </p>
      </div>
    </div>
  );
