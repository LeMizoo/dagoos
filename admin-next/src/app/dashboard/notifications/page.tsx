...
const typeLabels: Record<string, string> = {
  lead_action: 'Demandes',
  long_haul: 'Long-courrier',
  course_request: 'Courses',
  reservation: 'Réservations',
  VEHICLE_ASSIGNMENT_REQUEST: 'Affectations',
  info: 'Info',
};
...
export default function NotificationsPage() {
  ...
  const types = ['toutes', ...Object.keys(typeLabels)];
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          onClick={markAllRead}
          className="text-sm text-gray-600 hover:text-primary flex items-center gap-1 transition"
        >
          <CheckCheck size={16} />
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100">
        ...
        <div className="divide-y">
          {loading ? (
            ...
            filtered.map(n => {
              const config =
                typeConfig[n.type || 'info'] || typeConfig.info;
