...
function CoopLoginForm() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-900 to-emerald-700">
      <div className="bg-white rounded-2xl p-10 w-full max-w-md shadow-2xl">
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-green-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
            <Building2 size={32} className="text-green-600" />
          </div>
          <h1 className="text-2xl font-bold text-gray-800">Espace Coopérative</h1>
          <p className="text-gray-500 text-sm mt-1">Gérez votre coopérative de chauffeurs</p>
          <span className="inline-block bg-green-100 text-green-700 text-xs px-3 py-1 rounded-full mt-3">🏢 Coopérative</span>
        </div>
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input type="email" value={email} onChange={e => setEmail(e.target.value)}
              ...
              placeholder="coop@exemple.mg" required />
          </div>
          <div className="mb-6">
