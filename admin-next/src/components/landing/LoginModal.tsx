      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-primary"
                  required
                  autoComplete="email"
                />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-11 py-2.5 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-primary"
                  required
          ...
          <div className="mt-6 text-center text-xs text-gray-400">
            <a href="/urbain-login" className="hover:text-primary transition">
              Page Urbain dédiée
            </a>
